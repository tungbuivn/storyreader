...
@ArgsType()
class UpdateWebListArgs {
  @Field(() => WebListWhereUniqueInput, { nullable: false })
  where!: WebListWhereUniqueInput;
  @Field(() => WebListUpdateInput, { nullable: false })
  data!: WebListUpdateInput;
}

export { UpdateWebListArgs as UpdateWebListArgs };
